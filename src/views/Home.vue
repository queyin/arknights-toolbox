<template>
    <div class="mdui-row mdui-typo mdui-center" style="max-width: 1012px;">
        <div class="mdui-col-xs-12">
            ...
            <p>如果有好的想法、建议、希望增加的功能，或者发现了 BUG，欢迎到发送 <a href="https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=hina@amanohina.com target="_blank">邮件</a> 或 Pull Request</p>
